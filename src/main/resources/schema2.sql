...
CREATE TABLE `trip_sightseeing` (
  ...
  CONSTRAINT `4FK_trip_sightseeing_trip_sightseeing_nameid` FOREIGN KEY (`trip_sightseeing_nameid`) REFERENCES `sightseeings` (`idsightseeings`) ON DELETE SET NULL,
  CONSTRAINT `5FK_trip_sightseeing_trip_sightseeing_tripid` FOREIGN KEY (`trip_sightseeing_tripid`) REFERENCES `trip` (`idtrip`) ON DELETE SET NULL
...
-- Dump completed on 2018-12-31 16:54:19
