...
import com.my.travel.components.TripstoAnd;
...
public class restcontroller {
 //"jdbc:mysql://localhost:3306/travel1?useLegacyDatetimeCode=false&serverTimezone=Asia/Jerusalem&useSSL=false";
	...
	public List<ToAndApp> retrieveforcity(@PathVariable int id) {
	...
	@GetMapping("/gettrips")
	public List<TripstoAnd> gettrips1(){
		List<Trip> worklist=tripRepository.findAll();
		List<TripstoAnd> ans= worklist.stream().map(temp ->{TripstoAnd qq= new TripstoAnd(); qq.setId(temp.getIdtrip());qq.setTripname(temp.nameCompat()); return qq;}).collect(Collectors.toList());
		return ans;
	}
