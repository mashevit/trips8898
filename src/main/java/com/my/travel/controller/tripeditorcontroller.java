...
/*		Optional<Dish> studentOptional = dishRepository.findById(id);
	...
	@PostMapping("/updatetrip1")
	public String updatetrip1(@ModelAttribute("requestedTrip") Trip requestedTrip, @RequestParam String name, Model model) {
...
/*		Optional<Dish> studentOptional = dishRepository.findById(id);
		...
		student.setIddish(id);*/
		Traveler t=requestedTrip.getTraveler();
	...
	@ModelAttribute("travelerobj")
	public Traveler getraveller() {
		return new Traveler();
	}
